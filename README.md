...
This project uses the Bun test runner. Run the suite with:
...
- This project uses [Shadcn](https://ui.shadcn.com/) for UI components, which are built on top of Tailwind CSS.
